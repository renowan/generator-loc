  ...
  writing: function () {
  	...
  	if( this._args[0] ){
  		...
  		if( this._args[1] ){
  			...
  			this.fs.copyTpl(
  				this.templatePath('../../templates/coffee/view-BodyView.coffee'),
  				this.destinationPath(this.env.options.appPath+'/coffee/' + dirname + '/view-'+ myName +'View.coffee'),
  				{ moduleName: myName }
  			);
  			...
  			this.fs.copyTpl(
  				this.templatePath('../../templates/coffee/view-BodyView.coffee'),
  				this.destinationPath(this.env.options.appPath+'/coffee/view-'+ myName +'View.coffee'),
  				{ moduleName: myName }
  			);
